...
<doc>
    ...
    <members>
        ...
        <member name="M:NSwag.CodeGeneration.ClientGeneratorBase`3.#ctor(NSwag.SwaggerDocument,NJsonSchema.CodeGeneration.CodeGeneratorSettingsBase,NJsonSchema.CodeGeneration.TypeResolverBase)">
        ...
        <member name="M:NSwag.CodeGeneration.Models.OperationModelBase`2.#ctor(NJsonSchema.JsonSchema4,NSwag.SwaggerOperation,NJsonSchema.CodeGeneration.TypeResolverBase,NSwag.CodeGeneration.IClientGenerator,NSwag.CodeGeneration.ClientGeneratorBaseSettings)">
        ...
        <member name="M:NSwag.CodeGeneration.Models.ParameterModelBase.#ctor(System.String,System.String,System.String,NSwag.SwaggerParameter,System.Collections.Generic.IList{NSwag.SwaggerParameter},NJsonSchema.CodeGeneration.CodeGeneratorSettingsBase,NSwag.CodeGeneration.IClientGenerator,NJsonSchema.CodeGeneration.TypeResolverBase)">
        ...
        <member name="M:NSwag.CodeGeneration.Models.PropertyModel.#ctor(System.String,NJsonSchema.JsonProperty,System.String)">
            <inheritdoc />
        </member>
        ...
        <member name="M:NSwag.CodeGeneration.Models.ResponseModelBase.#ctor(NSwag.CodeGeneration.Models.IOperationModel,System.String,NSwag.SwaggerResponse,System.Boolean,NJsonSchema.JsonSchema4,NJsonSchema.CodeGeneration.CodeGeneratorSettingsBase,NSwag.CodeGeneration.IClientGenerator)">
        ...
        <member name="M:NSwag.CodeGeneration.OperationNameGenerators.SingleClientFromPathSegmentsOperationNameGenerator.GetClientName(NSwag.SwaggerDocument,System.String,NSwag.SwaggerOperationMethod,NSwag.SwaggerOperation)">
            <summary>Gets the client name for a given operation (may be empty).</summary>
            <param name="document">The Swagger document.</param>
            <param name="path">The HTTP path.</param>
            <param name="httpMethod">The HTTP method.</param>
        ...
        <member name="M:NSwag.CodeGeneration.OperationNameGenerators.SingleClientFromPathSegmentsOperationNameGenerator.GetOperationName(NSwag.SwaggerDocument,System.String,NSwag.SwaggerOperationMethod,NSwag.SwaggerOperation)">
            <summary>Gets the client name for a given operation (may be empty).</summary>
            <param name="document">The Swagger document.</param>
            <param name="path">The HTTP path.</param>
            <param name="httpMethod">The HTTP method.</param>

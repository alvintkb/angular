...
<doc>
    ...
    <members>
        ...
        <member name="M:NSwag.CodeGeneration.TypeScript.Models.TypeScriptOperationModel.#ctor(NSwag.SwaggerOperation,NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings,NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGenerator,NJsonSchema.CodeGeneration.TypeResolverBase)">
        ...
        <member name="M:NSwag.CodeGeneration.TypeScript.Models.TypeScriptParameterModel.#ctor(System.String,System.String,System.String,NSwag.SwaggerParameter,System.Collections.Generic.IList{NSwag.SwaggerParameter},NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings,NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGenerator,NJsonSchema.CodeGeneration.TypeResolverBase)">
        ...
        <member name="M:NSwag.CodeGeneration.TypeScript.Models.TypeScriptResponseModel.#ctor(NSwag.CodeGeneration.Models.IOperationModel,System.String,NSwag.SwaggerResponse,System.Boolean,NJsonSchema.JsonSchema4,NSwag.CodeGeneration.IClientGenerator,NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings)">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings.UseGetBaseUrlMethod">
        ...
        <member name="P:NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings.QueryNullValue">
            <summary>Gets or sets the null value used for query parameters which are null (default: '').</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings.HttpClass">
            <summary>Gets or sets the HTTP service class (applies only for the Angular template, default: HttpClient).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings.RxJsVersion">
            <summary>Gets the RxJs version (Angular template only, default: 6.0).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings.UseSingletonProvider">
            <summary>Gets a value indicating whether to use the Angular 6 Singleton Provider (Angular template only, default: false).</summary>
        </member>
        <member name="P:NSwag.CodeGeneration.TypeScript.SwaggerToTypeScriptClientGeneratorSettings.InjectionTokenType">
